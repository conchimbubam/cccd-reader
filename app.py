...
# Configure Gemini API - sử dụng environment variable để bảo mật
genai.configure(api_key=os.environ.get('GEMINI_API_KEY', 'AIzaSyAR1-TWKKqiVcEP0KBHFIMldKlMM94r0QE'))
